...
import indexxo.composeapp.generated.resources.indexed_object_selector_placeholder
...
@Composable
fun NoMoreItemsPlaceholder(modifier: Modifier) {
  Column(
    modifier = modifier,
    ...
    Text(
      text = stringResource(Res.string.indexed_object_selector_placeholder),
