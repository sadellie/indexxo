...
package io.github.sadellie.indexxo.feature.compare
...
import indexxo.composeapp.generated.resources.compare
...
import io.github.sadellie.indexxo.core.designsystem.icons.rounded.Compare
import io.github.sadellie.indexxo.core.designsystem.icons.rounded.SymbolsRounded
import org.jetbrains.compose.resources.stringResource

data object CompareTab : Tab {
  override val options: TabOptions
    @Composable
    get() {
      val title = stringResource(Res.string.compare)
      val icon = rememberVectorPainter(SymbolsRounded.Compare)
